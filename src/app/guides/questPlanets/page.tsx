      ...
      <SectionContent>
        <div className="px-4 md:px-10 flex flex-col">
              ...
              <ol className="list-decimal p-5 flex flex-col gap-y-2 text-desc">
                <li>
                  <p>
                    ...
                    busque um pouco em Anima Lake para que ela possa preparar o
                    Prato para Osiris. Basta usar scroll para Junon Polis e
                ...
                <li>
                  <p>
                    Depois disso volte a Reene e entregue os materiais (são 10).
                  </p>
                </li>
                <li>
          ...
          <section className="flex flex-col items-center mt-10">
            <picture className="flex flex-wrap-reverse gap-y-3 gap-x-4 items-center justify-center lg:justify-between lg:flex-nowrap">
              <div className="w-full lg:w-[50%] flex flex-col gap-y-3">
                <h4 className="text-tittle font-bold text-2xl">Quest Karkia</h4>
                <p className="text-desc">
                  Fale com o NPC Alphonso, que é responsável por teleportar para
                  outros planetas em Junon. Ele irá entregar a quest e indicar
                  os próximos passos.
                </p>
              </div>
              <Image
            ...
            <div className="text-left w-full p-2 mt-5">
              <ol className="list-decimal p-5 flex flex-col gap-y-2 text-desc">
                <li>
                  <p>
                    Os mobs da primeira parte ficam em Paradise of RA do lado do
                    lago.
                  </p>
                </li>
                <li>
                  <p>
                    Os itens necessários são dropados em Kenji Beach das Pedras
                    Kings (Mana Oil e Mana Heat) e os demais você consegue
                    dropar em qualquer mapa de Oro.
                  </p>
                </li>
                <li>
                  <p>
                    Com relação à quantidade necessária: 200 Damascus (Dropa em
                    Oro) 20 Mana Oil (Dropa em Junon - Kenji Beach daquelas
                    pedras Kings) 10 Steam Viper (Desmonta de Carts e Equips de
                    Carts) 10 Mana Heat (Dropa em Junon - Kenji Beach daquelas
                    pedras Kings) 5 Mana Generator (Dropa em Oro) 5 Mana Load
                    (Dropa em Oro) 5 Mana Article (Dropa em Oro)
                  </p>
                </li>
              </ol>
            </div>
          ...
          <section className="flex flex-col items-center mt-10">
            <picture className="flex flex-wrap gap-y-3 gap-x-4 items-center justify-center lg:justify-between lg:flex-nowrap">
              <Image
                ...
                className="rounded shadow-md w-[720px]"
              />
              <div className="w-full text-left lg:w-[50%] flex flex-col gap-y-3">
                <h5 className="text-tittle font-bold text-2xl">
                  Quest Skaaj / Hebarn
                </h5>
                <p className="text-desc">
                  Ao iniciar essa jornada, você deve estar ciente de que
                  precisará escolher um único destino ao final dela. Será uma
                  decisão difícil entre a bondosa e generosa deusa Arua e o
                  temido deus Hebarn. Por isso, durante a jornada, reflita com
                  sabedoria e tome a melhor decisão.
                </p>
              </div>
            </picture>
            ...
            <div className="text-left w-full p-2 mt-5 mb-20">
              <ol className="list-decimal p-5 flex flex-col gap-y-2 text-desc">
                <li>
                  <p>
                    (As Filhas de Landregin) e início de A Pirâmide do Destino.
                    Pega no Jones tendo todas as Tabuas (Bronze Ancient Table,
                    Silver Ancient Table, Gold Ancient Table, Platinum Ancient
                    Table e Diamond Ancient Table [Bronze Até Platinum Dropa em
                    Prison. Diamond dropa em Oro]). Ele vai te mandar conversar
                    com Lutis (fica em Valley of Luxem Tower, na torre logo q
                    sai de Zant) pra aprender sobre uma familia lá. Lutis vai te
                    mandar falar com o NPC ao lado dele (Karitte). Kattrine vai
                    te mandar falar com Harin (Taver Owner em Junon, lá perto de
                    onde compra Scroll). Tu volta no Jones e entrega a primeira
                    parte da quest. A partir daqui a quest Pirâmide do Destino
                    fica em stand-by e existirão outras que devem ser
                    completadas.
                  </p>
                </li>
                <li>
                  <p>
                    ...
                    Lago em Anima Lake. Esse NPC manda tu falar com um que tá lá
                    em El Verloon Desert (Orias) numa vila em cima de uma
                    pirâmide. Esse NPC vai te mandar falar com um Mercador
                    Cigano (Methio) que fica na mesma vila dps do laguinho. Dps
                    disso tu volta no Jones e entrega a segunda parte da quest.
                  </p>
                </li>
                <li>
                  <p>
                    (Khan vs Char): Ele te manda falar com Jeffrey Loyd (NPC que
                    vende Skill Nv. 200 em Eldeon). Selecionando as opções
                    ...
                    mandar na imagem ali embaixo. Depois disso volta pro Jones e
                    entrega a 3ª parte.
                  </p>
                </li>
                <li>
                  <p>
                    ...
                    idioma de Luna e Karkia). Selecionando as opções certas ele
                    vai te mandar falar com Pabel (o que vende scroll em Eucar).
                    Tendo falado com ele, retorna pro Jones e entrega a 4ª
                    parte.
                  </p>
                </li>
                <li>
                  <p>
                    (Herdeiro dos Anônimos): Jones diz para encontrar alguém que
                    já está morto. Em Desert of The Dead (DoD) você deve falar
                    com Lantore para prosseguir na quest.
                    <br />O Padre Morto diz para encontrar alguém que pode falar
                    com os Deuses. Esse alguém é a {"Arua's"} Fairy lá em
                    Adventure Plains (mapa que nasce char novo, logo em frente
                    ao spawn). Depois disso é só voltar em Junon e entregar a 5ª
                    parte ao Jones.
                  </p>
                </li>
                <li>
                  <p>
                    ...
                    um dos Servos (Arua ou Hebarn). O que tu escolher vai ser o
                    Planeta que tu pode Ir (o de Arua leva pra Skaaj)
                  </p>
                </li>
              </ol>
            </div>
